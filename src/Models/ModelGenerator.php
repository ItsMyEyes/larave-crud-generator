...
namespace Kiyora\CrudGenerator\Models;
...
class ModelGenerator
{
    ...
    private function _init()
    {
        ...
        //     if ($relation->ref) {
        //         $tableKeys = $this->_getTableKeys($relation->table_name);
        //         $eloquent = $this->_getEloquent($relation, $tableKeys);
        //     } else {
        //         $eloquent = 'hasOne';
        //     }

        //     $this->functions .= $this->_getFunction($eloquent, $relation->table_name, $relation->foreign_key, $relation->local_key);
        // }
    }
...
// SQL;
        ...
        and         cu.table_name = '".$this->table."'
        and         tc.table_catalog = 'scbd_dev'
